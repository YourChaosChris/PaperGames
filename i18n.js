...
const STRINGS = {
  en: {
    ...
    home_gomoku_desc: "Get five stones in a row first, on a Go-sized board.",
    game_senet: "Senet",
  ...
  de: {
    ...
    home_gomoku_desc: "Bringe als Erster fünf Steine in eine Reihe, auf einem Go-großen Brett.",
    game_senet: "Senet",
